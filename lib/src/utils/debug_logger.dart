...
class DebugLogger {
  ...
  static void aiCall(String provider, String prompt, {Object? response, Object? error}) {
    if (error != null) {
      DebugLogger.error('AI call failed to $provider', tag: 'AI', error: error);
    } else {
      info('AI call to $provider completed', tag: 'AI', data: {
  ...
  static void stateChange(String component, String from, String to, {Object? data}) {
